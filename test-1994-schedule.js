/**
 * Test script for 1994 schedule application (28 teams)
 * Goal: Apply 1994 regular season schedule
 * - 28 teams (no Panthers, Jaguars, Ravens, Texans)
 * - 16-game season
 * - Expansion teams won't appear in regular season
...
async function test() {
  ...
  const dst = 'C:/Users/tshan/Documents/Madden NFL 26/Saves/CAREER-1994TEST';
  ...
  console.log('Teams:', [...teamsInSchedule].sort((a,b) => a-b).map(t => `${t}(${teamIndexToName.get(t)})`).join(', '));
  ...
  console.log('\n=== TRY LOADING CAREER-1994TEST IN MADDEN ===');
}
