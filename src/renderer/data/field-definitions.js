...
export const MADDEN_FIELDS = {
    ...
    'PPOS': { display: 'Position', type: 'lookup', editable: false, width: 80, lookup: 'positions' },
    'TGID': { display: 'Team', type: 'lookup', editable: false, width: 80, lookup: 'teams' },
    'PJEN': { display: 'Jersey #', type: 'numeric', editable: true, width: 80, min: 0, max: 99 },
    'PCOL': { display: 'College', type: 'lookup', editable: false, width: 100, lookup: 'colleges' },
    ...
    'PHSN': { display: 'State', type: 'lookup', editable: false, width: 80, lookup: 'states' },
